...
# installed.
TCL_PREFIX='F:/IAP validator/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='F:/IAP validator/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='F:/IAP validator/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IF:/IAP validator/venv\Library\include'
...
TCL_PACKAGE_PATH='F:/IAP validator/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LF:/IAP validator/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='F:/IAP validator/venv\Library\lib\tclstub86.lib'
